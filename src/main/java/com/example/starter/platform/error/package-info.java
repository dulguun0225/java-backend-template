 ...
 * implements, plus the two exceptions a feature throws to reach the render edge,
 * {@link com.example.starter.platform.error.ValidationFailed} and
 * {@link com.example.starter.platform.error.Rejected}, each carrying a catalog entry rather than an inline
